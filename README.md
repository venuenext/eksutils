...
The [Dockerfile](https://github.com/venuenext/eksutils/blob/master/Dockerfile) for the `eksutils` container is based on an Amazon Linux OS image and it includes the following tools and utilities:
...
```
docker run --rm venuenext/eksutils:latest /utilsversions.sh
```
...
##### Option #1
```
docker run -it --rm venuenext/eksutils:latest
```
Use this option if:
...
##### Option #2
```
docker run -it --rm -v $HOME/.aws:/root/.aws -v $HOME/.kube:/root/.kube venuenext/eksutils:latest`
```
Use this option if:
...
##### Option #3
```
docker run -it --rm --network host -v $HOME/.aws:/root/.aws -v $HOME/.kube:/root/.kube venuenext/eksutils:latest`
```
Use this option if:
...
##### Option #4  
```
docker run -it --rm --network host -v $HOME/.aws:/root/.aws -v $HOME/.kube:/root/.kube -v $HOME/myfolder:/myfolder venuenext/eksutils:latest
```
Use this option if:
...
##### Option #5  
```
docker run -it --rm --network host -v $HOME/.aws:/root/.aws -v $HOME/.kube:/root/.kube -v $HOME/environment:/environment -v /var/run/docker.sock:/var/run/docker.sock venuenext/eksutils:latest`
```
Use this option if:
...
```
docker run -it --rm --network host -v $HOME/.aws:/root/.aws -v $HOME/.kube:/root/.kube -v $HOME/environment:/environment venuenext/eksutils:latest
```
...
```
docker run -it --rm -p 8080:8080 -v $HOME/.aws:/root/.aws -v $HOME/.kube:/root/.kube venuenext/eksutils:latest`
```
